<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 075" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 075｜رسم بأقلام شمعية داكنة

### يحفظ أهم أثر في الصورة بقلم شمعي داكن ومساحة لونية ناعمة وفراغ ورقي يتنفس
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 075 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تفرط كثير من معالجات «الرسم اليدوي العتيق» في وصف الصورة، أو تغطيها بمرشح ورق قديم عام. يبقى العنصر، لكن الوقفة والمسافة والذاكرة الخاصة تختفي.

يحافظ **Panel 075** على نسب العنصر واتجاهه وبنيته ووضعه الأساسية، ثم يعيد رسمه بخطوط قلم شمعي داكن حرة تحمل وقفات وتصحيحات طفيفة. تسند مساحة لونية واحدة غير منتظمة ومنخفضة التشبع العنصر ولا تملأ الصورة، بينما يحمل الورق اليدوي العاجي والفراغ الواسع الشعور والمسافة والزمن. تبدو حروف الآلة الكاتبة الصغيرة كملاحظة خاصة لا كعنوان تجاري.

### مناسب لـ

- تجاوز مرشحات العتق القالبية وجعل الخط والورق والحبيبات والحذف عناصر ذات معنى؛
- الرسم بأقل قدر مع الحفاظ الدقيق على النسب والاتجاه والبنية والوضع؛
- توجيه فني هادئ يجمع مساحة لونية واحدة وحبيبات ريسوغراف وفراغًا واسعًا وملاحظات آلة كاتبة مقتصدة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 075 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** تخطيط قلم شمعي داكن · ورق يدوي عاجي · مساحة لونية ناعمة غير منتظمة · حبيبات ريسوغراف · فراغ واسع · ملاحظة آلة كاتبة خاصة
...
|---|---|
| **الناتج** | ملصق تخطيط ورقي مقتصد يشبه صفحة من منشور مستقل خاص |
| **البصمة الواضحة** | قلم شمعي داكن فوق ورق يدوي عاجي ومساحة لونية ناعمة واحدة، مع حبيبات ريسوغراف خافتة |
| **احترام المصدر** | يحذف التفاصيل ويحافظ على النسب والاتجاه والبنية والوضع والعلاقة؛ ويتبع اللون الموجّه الأصلي |
...
```text
استخلاص العنصر والمحيط والوضع والعلاقة → الاختزال إلى البنية الضرورية للتعرف → إعادة الرسم بقلم شمعي داكن حر → إسناده بمساحة لونية واحدة غير منتظمة ومنخفضة التشبع → إبقاء فراغ واسع على ورق عاجي يدوي → إضافة حبيبات ريسوغراف خافتة → ترك ملاحظة آلة كاتبة خاصة بالغة القلة
```

## سمات النتيجة النهائية

- تسمح خطوط القلم الشمعي الداكن بالوقفة والتكرار والتصحيح مع بقاء البنية المعرّفة دقيقة.
- تسند مساحة لونية واحدة ناعمة ومنخفضة التشبع العنصر ولا تملأ الخلفية.
- يصنع الورق العاجي اليدوي وحبيبات ريسوغراف الخافتة والفراغ الواسع الملمس والمسافة والزمن.
- تحدد أقوى علاقة بنيوية في الأصل موضعًا وسطًا أو منخفضًا بدل التوسيط الآلي.
- تتصرف حروف الآلة الكاتبة الصغيرة والخفيفة ذات الخطأ الميكانيكي كملاحظة خاصة لا عنوان تجاري.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-075-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 075. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-075 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-075 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-075 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-075 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-075 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 075 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-075 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-075`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-075-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-075-prompt.zh-CN.md)
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–075) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
