...
```text
/xxd-panel-075 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，075 设计在下）
2. 左右对照（原图在左，075 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-075/<fresh-task>/
...
- `references/xxd-panel-075-prompt.zh-CN.md`
- `references/xxd-panel-075-prompt.en.md`
