...
検証可能なオリジナル公開作例と出典が未提供のため、`sample-01`–`sample-04` は掲載していません。上の8点は、16:9の横長・左右構成4点と、3:4の縦長・上下構成4点です。すべて Panel 075 が自身の原文プロンプトに基づいて個別に生成したもので、別番号の作品は流用していません。作例のコピーは英語で自動生成しています。
